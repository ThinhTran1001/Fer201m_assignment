...
export default function Home() {
    return (
        <div style={{ marginTop: '15px' }}>
            <Container>
                <Row>
                    <Col md={6}><Button style={{backgroundColor:'#F86338', color:'black', fontWeight:'bolder'}} variant="outline-warning">ĐIỆN THOẠI NỔI BẬT NHẤT</Button></Col>
                    
                    <Col md={6}>
                        <Row>
                            <Col><Button style={{backgroundColor:'#F86338',color:'black', fontWeight:'bolder', fontSize:'14px'}} variant="outline-warning">Apple</Button></Col>
                            <Col><Button style={{backgroundColor:'#F86338',color:'black', fontWeight:'bolder', fontSize:'14px'}} variant="outline-warning">Samsung</Button></Col>
                            <Col><Button style={{backgroundColor:'#F86338',color:'black', fontWeight:'bolder', fontSize:'14px'}} variant="outline-warning">Xiaomi</Button></Col>
                            <Col><Button style={{backgroundColor:'#F86338',color:'black', fontWeight:'bolder', fontSize:'14px'}} variant="outline-warning">OPPO</Button></Col>
                            <Col><Button style={{backgroundColor:'#F86338',color:'black', fontWeight:'bolder', fontSize:'14px'}} variant="outline-warning">Xem Tất Cả</Button></Col>
                        </Row>
                    </Col>
                </Row>
