        ...
        <div style={{ marginTop: '25px' }}>
            <Container>
                ...
                <Row style={{ marginTop: '5px', display: 'flex' }}>
                    {
                        product.filter(p => p.categoryId === 1).map(filteredProduct => {
                            return (

                                <Col xs={12} sm={6} md={3} style={{ marginTop: '15px' }} >
                                    <Card className='hover:-translate-y-2' style={{ width: '18rem', textAlign: 'center' }}>
                ...
                <Row style={{ marginTop: '45px' }}>
                    ...
                    <Col md={6}>
                        <Row>
                            ...
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">MSI</Button></Col>
                ...
                <Row style={{ marginTop: '1px', display: 'flex' }}>
                    {
                        product.filter(p => p.categoryId === 5).map(filteredProduct => {
                            return (

                                <Col xs={12} sm={6} md={3} style={{ marginTop: '15px' }} >
                                    <Card style={{ width: '18rem', textAlign: 'center' }}>
                                        <Card.Img hover style={{ height: '280px' }} src={filteredProduct.img} />
                                        <Card.Body>
                                            <Card.Title style={{ textAlign: 'center', fontSize: '15px' }}>{filteredProduct.name}</Card.Title>
                                            <Card.Text>
                                                <Row>
                                                    <Col>{filteredProduct.price}</Col>
                                                </Row>
                ...
                <Row style={{ marginTop: '45px' }}>
                    <Col md={6}><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder' }} variant="outline-warning">TABLET</Button></Col>
                    <Col md={6}>
                        <Row>
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">Apple</Button></Col>
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">Samsung</Button></Col>
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">Lenovo</Button></Col>
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">OPPO</Button></Col>
                            <Col><Button style={{ backgroundColor: 'rgb(220, 100, 11)', color: 'white', fontWeight: 'bolder', fontSize: '14px' }} variant="outline-warning">Xem Tất Cả</Button></Col>
                        </Row>
                    </Col>
                ...
                <Row style={{ marginTop: '1px', display: 'flex' }}>
                    {
                        product.filter(p => p.categoryId === 4).map(filteredProduct => {
                            return (
